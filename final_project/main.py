...
# # if the initial query doesn't return 500 results, it's called again but without quotation marks
# download_elastic(directory_of_large_json_files_from_elastic_search, 500)
# download_elastic('/Users/seanfletcher/Desktop/simple_text_json_files/query_results_100/', 100)
...
# # gets a baseline score for them. So I know if anything I do is improving them.
# base_line_top_100_dict_from_json = read_all_jsons_for_baseline('/Users/seanfletcher/Desktop/simple_text_json_files/query_results_100/')
